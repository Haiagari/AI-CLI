...
Community leaders are responsible for clarifying the standards and enforcing them fairly.

Those who do not follow the Code of Conduct may face:
- Warning
...
1. **Document** the incident (date, time, details)
2. **Report privately** to maintainers
3. **Provide context** and any supporting evidence
4. **Maintain confidentiality** - reports are handled discreetly
...
For questions about this Code of Conduct, please contact the maintainers.
